 ...
 */
public class simpleobligation_map_composition extends Tffst {
  ...
  public simpleobligation_map_composition() {


	simpleobligation sp = new simpleobligation();

	Utils.showDot(sp.toDot("so"));

	map_h1_h2_2 map = new map_h1_h2_2();

	Utils.showDot(map.toDot("map"));
	
	TfI man = new SimpleTf("man");
	
	Knowledge.implications.add(new Implication(Tf.createdTFs.get("sign"),Tf.createdTFs.get("man")));
	Knowledge.implications.add(new Implication(Tf.createdTFs.get("read"),Tf.createdTFs.get("man")));
//	Knowledge.implications.add(new Implication(Tf.createdTFs.get("sign"),Tf.createdTFs.get("write")));
	...
	Knowledge.implications.add(new Implication(Tf.createdTFs.get("read"),Tf.createdTFs.get("see").not()));
	Knowledge.implications.add(new Implication(Tf.createdTFs.get("see"),Tf.createdTFs.get("man").not()));
	Knowledge.implications.add(new Implication(Tf.createdTFs.get("see"),Tf.createdTFs.get("write").not()));

	Knowledge.implications.add(new Implication(Tf.createdTFs.get("pat"),Tf.createdTFs.get("phy").not()));
	Knowledge.implications.add(new Implication(Tf.createdTFs.get("sign"),Tf.createdTFs.get("phy").not()));
	Knowledge.implications.add(new Implication(Tf.createdTFs.get("sign"),Tf.createdTFs.get("write").not()));

	t = composition(map, sp);
  ...
  public static void main(String[] args) {
	...
	simpleobligation_map_composition c = new simpleobligation_map_composition();

//	Utils.showDot(c.toDot("", "LR"), "/home/javier/Dropbox/sharelatex/interoperability/simpleobligation_map");
	Utils.showDot(c.toDot("", "LR"));
