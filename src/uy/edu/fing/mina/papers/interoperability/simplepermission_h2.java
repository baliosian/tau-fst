 ...
 */
public class simplepermission_h2 extends Tffst {
  ...
  public simplepermission_h2() {
	
	t = new Tffst();
	
	TfI p = new SimpleTf("hp");
	TfI m = new SimpleTf("man");
	TfI r = new SimpleTf("rec");
...
//	s0.addOutTran(new Transition(p.not(), SimpleTf.Epsilon(), s0));

	s0.addOutTran(new Transition(p, p, s1, 1));
	s1.addOutTran(new Transition(m, m, s2, 1));
	s2.addOutTran(new Transition(r, r, s3, 1));

//	s3.addOutTran(new Transition(SimpleTf.AcceptsAll(), SimpleTf.Epsilon(), s3));
   ...
   public static void main(String[] args) {
      ...
      simplepermission_h2 s = new simplepermission_h2();
      
      Utils.showDot(s.toDot("","LR"),"/home/javier/Dropbox/sharelatex/interoperability/simplepermission_h2");
