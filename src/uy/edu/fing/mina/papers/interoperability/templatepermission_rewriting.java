 ...
 */
public class templatepermission_rewriting extends Tffst {
  ...
  public templatepermission_rewriting() {
	
	t = new Tffst();
	
	TfI doctor = new SimpleTf("doctor");
	TfI write = new SimpleTf("write");
	TfI medical_record = new SimpleTf("medical_record");
	TfI context_1 = new SimpleTf("context_1");
	...
	s0.addOutTran(new Transition(context_1, context_1, s1, 1));
	s1.addOutTran(new Transition(doctor, doctor, s2, 1));
	s2.addOutTran(new Transition(write, write, s3, 1));
	s3.addOutTran(new Transition(medical_record, medical_record, s4, 1));
   ...
   public static void main(String[] args) {
      ...
      templatepermission_rewriting s = new templatepermission_rewriting();
      
      Utils.showDot(s.toDot("","LR"),"/home/javier/Dropbox/sharelatex/interoperability/templatepermission_rewriting");
