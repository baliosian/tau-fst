 ...
 */
public class map_h1_h2_2 extends Tffst {
  ...
  public map_h1_h2_2() {
	...
	s0.addOutTran(new Transition(phy.not(),phy.not(), s0, 1));

	s0.addOutTran(new Transition(phy, hp, s1));
	s1.addOutTran(new Transition(write.not(), write.not(), s2,1));
	
	//s2.addOutTran(new Transition(phy.not(), phy.not(), s2));
	
	t = t.kleene();
	

//	
//	s1.addOutTran(new Transition(read.not(), read.not(), s0));
//
//	s2.addOutTran(new Transition(phy.not(), phy.not(), s0));
//	s2.addOutTran(new Transition(phy, hp, s1));
  ...
  public static void main(String[] args) {
	...
	map_h1_h2_2 p = new map_h1_h2_2();
	
//    Utils.showDot(p.toDot("","LR"),"/home/javier/Dropbox/sharelatex/interoperability/map_h1_h2");
    Utils.showDot(p.toDot(""),"/home/javier/Dropbox/sharelatex/interoperability/map_h1_h2");
