 ...
 */
public class rule1_map_rule2_intersection extends Tffst {
  ...
  public rule1_map_rule2_intersection() {


	Tffst fst1 = new rule1_map_composition();

	Utils.showDot(fst1.toDot("rule1_map"));

	Tffst fst2 = new map_rule2_composition();

	Utils.showDot(fst2.toDot("map_rule2"));
...
//	Knowledge.implications.add(new Implication(Tf.createdTFs.get("rek"),Tf.createdTFs.get("hp").not()));
...
//	System.out.println(Tf.createdTFs.get("phy").andSimple(Tf.createdTFs.get("hp")));
  ...
  public static void main(String[] args) {
	...
	rule1_map_rule2_intersection c = new rule1_map_rule2_intersection();

	Utils.showDot(c.toDot("", "LR"), "/home/javier/Dropbox/sharelatex/interoperability/intersection");
