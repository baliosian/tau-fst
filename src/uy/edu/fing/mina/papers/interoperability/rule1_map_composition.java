 ...
 */
public class rule1_map_composition extends Tffst {
  ...
  public rule1_map_composition() {


	simplepermission_h1 sp = new simplepermission_h1();
  ...
  public static void main(String[] args) {
	...
	rule1_map_composition c = new rule1_map_composition();

	Utils.showDot(c.toDot("", "LR"), "/home/javier/Dropbox/sharelatex/interoperability/rule1_map_composition");
