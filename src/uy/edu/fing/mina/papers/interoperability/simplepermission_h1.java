 ...
 */
public class simplepermission_h1 extends Tffst {
  ...
  public simplepermission_h1() {
	
	t = new Tffst();
	
	TfI p = new SimpleTf("phy");
...
//	s3.addOutTran(new Transition(p.not(), p.not(), s3, 1));
   ...
   public static void main(String[] args) {
      ...
      simplepermission_h1 s = new simplepermission_h1();
      
      Utils.showDot(s.toDot("","LR"),"/home/javier/Dropbox/sharelatex/interoperability/simplepermission_h1");
