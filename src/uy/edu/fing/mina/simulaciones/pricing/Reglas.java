...
//		Regla 16 : if competitor price higher and competitor price increasing fast then increase price fast
		...
		estado1.addTransition(new Transition(eventos.getEvento("competitorPriceHigher"), epsilon, estado2));
		estado2.addTransition(new Transition(eventos.getEvento("competitorPriceIncreasingFast"), acciones.getAccion("increasePriceFast"), estado3));
...
//		Regla 17 : if competitor price higher and competitor price increasing slow then increase price slow
		...
		estado1.addTransition(new Transition(eventos.getEvento("competitorPriceHigher"), epsilon, estado2));
		estado2.addTransition(new Transition(eventos.getEvento("competitorPriceIncreasingSlow"), acciones.getAccion("increasePriceFast"), estado3));
...
//		Regla 18 : if competitor price higher and competitor price steady then increase price slow
		...
		estado1.addTransition(new Transition(eventos.getEvento("competitorPriceHigher"), epsilon, estado2));
		estado2.addTransition(new Transition(eventos.getEvento("competitorPriceSteady"), acciones.getAccion("increasePriceSlow"), estado3));
...
//		Regla 19 : if competitor price higher and competitor price increasing fast then increase price fast
		...
		estado1.addTransition(new Transition(eventos.getEvento("competitorPriceHigher"), epsilon, estado2));
		estado2.addTransition(new Transition(eventos.getEvento("competitorPriceDecreasingFast"), acciones.getAccion("decreasePriceSlow"), estado3));
...
//		Regla 20 : if competitor price higher and competitor price increasing fast then increase price fast
		...
		estado1.addTransition(new Transition(eventos.getEvento("competitorPriceLower"), epsilon, estado2));
		estado2.addTransition(new Transition(eventos.getEvento("competitorPriceIncreasingFast"), acciones.getAccion("decreasePriceFast"), estado3));
...
//		Regla 21 : if competitor price higher and competitor price increasing fast then increase price fast
		...
		estado1.addTransition(new Transition(eventos.getEvento("competitorPriceLower"), epsilon, estado2));
		estado2.addTransition(new Transition(eventos.getEvento("competitorPriceIncreasingSlow"), acciones.getAccion("decreasePriceSlow"), estado3));
...
//		Regla 22 : if competitor price higher and competitor price increasing fast then increase price fast
		...
		estado1.addTransition(new Transition(eventos.getEvento("competitorPriceLower"), epsilon, estado2));
		estado2.addTransition(new Transition(eventos.getEvento("competitorPriceSteady"), acciones.getAccion("decreasePriceFast"), estado3));
...
//		Regla 23 : if competitor price higher and competitor price increasing fast then increase price fast
		...
		estado1.addTransition(new Transition(eventos.getEvento("competitorPriceLower"), epsilon, estado2));
		estado2.addTransition(new Transition(eventos.getEvento("competitorPriceDecreasingSlow"), acciones.getAccion("decreasePriceSlow"), estado3));
...
//		Regla 24 : if competitor price higher and competitor price increasing fast then increase price fast
		...
		estado1.addTransition(new Transition(eventos.getEvento("competitorPriceLower"), epsilon, estado2));
		estado2.addTransition(new Transition(eventos.getEvento("competitorPriceDecreasingFast"), acciones.getAccion("decreasePriceFast"), estado3));
