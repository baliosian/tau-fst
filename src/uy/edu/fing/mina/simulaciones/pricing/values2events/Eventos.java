...
public class Eventos {
	...
	private void popular(){
		...
		nuevo.addInitString("{target_service=\"AP2VE/lupa/rmoon\", command=\"watch_mib\", mib=\"price\", op=\">\", value=\"0\", notification_id=\"AP2-Price\" .. math.random(2^30), watcher_id=\"AP2Price\" .. configuration.my_name_pdp, timeout=\"10\"}");
		nuevo.addInitString("{target_service=\"AP3VE/lupa/rmoon\", command=\"watch_mib\", mib=\"price\", op=\">\", value=\"0\", notification_id=\"AP3-Price\" .. math.random(2^30), watcher_id=\"AP3Price\" .. configuration.my_name_pdp, timeout=\"10\"}");
		nuevo.addInitString("{target_service=\"AP4VE/lupa/rmoon\", command=\"watch_mib\", mib=\"price\", op=\">\", value=\"0\", notification_id=\"AP4-Price\" .. math.random(2^30), watcher_id=\"AP4Price\" .. configuration.my_name_pdp, timeout=\"10\"}");
		nuevo.addInitString("{target_service=\"AP5VE/lupa/rmoon\", command=\"watch_mib\", mib=\"price\", op=\">\", value=\"0\", notification_id=\"AP5-Price\" .. math.random(2^30), watcher_id=\"AP5Price\" .. configuration.my_name_pdp, timeout=\"10\"}");
		nuevo.addInitString("{target_service=\"AP6VE/lupa/rmoon\", command=\"watch_mib\", mib=\"price\", op=\">\", value=\"0\", notification_id=\"AP6-Price\" .. math.random(2^30), watcher_id=\"AP6Price\" .. configuration.my_name_pdp, timeout=\"10\"}");
		nuevo.addInitString("{target_service=\"AP7VE/lupa/rmoon\", command=\"watch_mib\", mib=\"price\", op=\">\", value=\"0\", notification_id=\"AP7-Price\" .. math.random(2^30), watcher_id=\"AP7Price\" .. configuration.my_name_pdp, timeout=\"10\"}");
		nuevo.addInitString("{target_service=\"AP8VE/lupa/rmoon\", command=\"watch_mib\", mib=\"price\", op=\">\", value=\"0\", notification_id=\"AP8-Price\" .. math.random(2^30), watcher_id=\"AP8Price\" .. configuration.my_name_pdp, timeout=\"10\"}");
		nuevo.addInitString("{target_service=configuration.my_name_rmoon, command=\"watch_mib\", mib=\"number_of_clients\", op=\">\", value=\"-1\", notification_id=configuration.my_name_rmoon .. \"Clients\" .. math.random(2^30), watcher_id=\"MyClients\" .. configuration.my_name_pdp, timeout=\"10\"}");
